...
from catalog.views import (ContactsView, HomeView, ProductCreateView, ProductDeleteView, ProductDetailView,
                           ProductListView, ProductUpdateView, ProductByCategoryListView, ProductCategoryListView)
...
urlpatterns = [
    ...
    path("catalog/category/", ProductCategoryListView.as_view(), name="product_categories",),
    path("catalog/category/<int:category_id>/", ProductByCategoryListView.as_view(), name="products_by_category",),
